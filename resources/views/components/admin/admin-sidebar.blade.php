        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item mb-2">
                    <a class="sidebar-link {{ request()->routeIs('admin.dashboard*') ? 'sidebaractive' : '' }}"
                ...
                <li class="sidebar-item mb-2">
                    <a class="sidebar-link {{ request()->routeIs('admin.kelolaperusahaan*') ? 'sidebaractive' : '' }}"
                        href="{{ route('admin.kelolaperusahaan') }}" aria-expanded="false">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li class="sidebar-item mb-2">
                    <a class="sidebar-link {{ request()->routeIs('admin.kelolajurusan*') ? 'sidebaractive' : '' }}"
                        href="{{ route('admin.kelolajurusan') }}" aria-expanded="false">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li class="sidebar-item mb-2">
                    <a class="sidebar-link {{ request()->routeIs('admin.verifikasi*') ? 'sidebaractive' : '' }}"
                        href="{{ route('admin.verifikasi') }}" aria-expanded="false">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
